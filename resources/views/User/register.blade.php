        ...
        <div class="col-lg-5">
            ...
            <div class="card mt-5">
                <div class="card-body">
                    ...
                    <form action="{{ route('pengwar.register') }}" method="POST">
                        @csrf
                        ...
                        <button type="submit" class="btn btn-primary" style="width: 100%; font-weight: 600">DAFTAR</button>
                    </form>
                </div>
            </div>
            ...
            @endif
            <a href="{{ route('pengwar.index') }}" class="btn btn-danger text-white mt-3" style="width: 100%; font-weight: 600">Kembali ke Halaman Utama</a>
        </div>
    </div>
</div>
@endsection
