...
@section('title', 'PENGWAR - PENGADUAN WARGA')
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    ...
                    <ul class="navbar-nav text-center ml-auto">
                        <li class="nav-item">
                            <a class="nav-link ml-3 text-white" href="{{ route('pengwar.laporan') }}">Laporan</a>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link ml-3 text-white" href="{{ route('pengwar.logout') }}">Logout</a>
                        </li>
                    </ul>
                    @else
                    <ul class="navbar-nav text-center ml-auto">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('pengwar.formRegister') }}" class="btn btn-outline-purple">Daftar</a>
                        </li>
                    </ul>
                    @endauth
                </div>
...
<div class="container">
    <div class="row justify-content-between">
        ...
        <div class="col-lg-4 col-md-12 col-sm-12 col-12 col">
            ...
            <div class="card content content-bottom shadow">
                <img src="{{ asset('images/user_default.svg') }}" alt="John" style="width:100%">
                <h1>{{ Auth::guard('masyarakat')->user()->nama }}</h1>
                <p class="title">{{ Auth::guard('masyarakat')->user()->username }}</p>
                <div>
    ...
    <div class="row mt-5 ">
        <div class="col-lg-8">
            <a class="d-inline tab {{ $siapa != 'me' ? 'tab-active' : ''}} mr-4" href="{{ route('pengwar.laporan') }}">
                Semua
            </a>
            <a class="d-inline tab {{ $siapa == 'me' ? 'tab-active' : ''}}" href="{{ route('pengwar.laporan', 'me') }}">
                Laporan Saya
            </a>
            <hr>
        </div>
...
<div class="mt-5">
    <hr>
    <div class="text-center">
        <p class="italic text-secondary">© 2021 Made With Bagas P. Created With <i style="color:#ff5555;"
                class="fa fa-heart"></i> • All rights reserved</p>
    </div>
</div>
@endsection
