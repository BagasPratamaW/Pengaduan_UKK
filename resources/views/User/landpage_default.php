...
<section class="header" >
        ...
        <div class="container">
            <div class="container-fluid">
                <a class="navbar-brand" href="#">
                    <h4 class="semi-bold mb-0 text-white">PENGWAR</h4>
    ...
    <div class="text-center">
        ...
        <p class="italic text-white mb-5">Isi Laporan Anda Agar Kami Bisa Memproses Ke Pihak Terkait</p>
    </div>
</section>
            ...
            <form action="{{ route('pekat.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <input type="text" value="{{ old('tgl_kejadian') }}" name="tgl_kejadian"
                        placeholder="Kapan Tanggal Kejadian Tersebut?" class="form-control" onfocusin="(this.type='date')"
...
<div class="pengaduan mt-5">
    <div class="bg-purple">
        <div class="text-center">
            <h5 class="medium text-white mt-3">JUMLAH LAPORAN TELAH DITANGANI</h5>
...
<div class="mt-5">
    <hr>
    <div class="text-center">
        <p class="italic text-secondary">© 2021 Bagas P. Created With <i style="color:#ff5555;" class="fa fa-heart"></i> • All rights reserved</p>
    </div>
</div>
{{-- Modal --}}
